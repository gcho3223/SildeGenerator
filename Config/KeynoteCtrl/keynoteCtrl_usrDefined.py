#!/usr/bin/env python3
"""
User-defined Mode Keynote Control Functions
...
def insert_pdfs_into_slide_usrDefined(output_file, base_dir, path_template, filename_template,
    ...
    if scan_mode:
        ...
        from Config.Rules.usrDefined_template_engine import template_to_regex

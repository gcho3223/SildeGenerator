"""
User-defined Mode Rules - Dynamic path generation for user-defined templates
"""
import os
from typing import Dict, List, Tuple, Optional, Any
from Config.Rules.usrDefined_template_engine import (
...
def get_usrDefined_file_path(base_dir: str,
                        path_template: str,
...
def find_usrDefined_files(base_dir: str,
                     path_template: str,
                     filename_template: str,
...
def get_usrDefined_file_path_with_fallback(base_dir: str,
                                      path_template: str,
                                      filename_template: str,
                                      variables: Dict[str, any],
                                      file_format: str = "pdf",
    ...
    file_path = get_usrDefined_file_path(
...
def find_usrDefined_files_scan(base_dir: str,
                                filename_template: str,
                                variable_combinations: Dict[str, List[any]],
                                file_format: str = "pdf",
                                log_callback=None) -> Tuple[List[Tuple[str, Dict[str, any]]], Dict[str, any], List[Tuple[str, Dict[str, Any], str]]]:
    """
    Find files using scan mode: recursively scan directory and match against filename template
    ...
    matched_results, stats = scan_and_match_files(
        base_dir, filename_template, file_format, variable_combinations, log_callback
    )
